...
def chat():
    ...
    system_prompt = (
        ...
        "- Arabe standard → réponds en arabe\n"
        "- Darija marocaine (mélange arabe/français/amazigh, caractères latins ou arabes) → réponds en darija marocaine dans le même script que l'utilisateur\n"
        "- Ne jamais mélanger les langues sauf si l'utilisateur le fait\n"
        "- Tu t'adresses à des agriculteurs — sois précis, pratique, concis\n\n"
        "Règles de réponse:\n"
